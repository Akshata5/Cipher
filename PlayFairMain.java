...
public class PlayFairMain implements  CipherInterface {
	String cipher;
 ...
 // }
  ...
  PlayFairMain(String key, String enc, String fileName, String xyz) throws Exception{
  ...
  //  System.out.println();
   ...
   // System.out.println("using the previously given keyword");
    readfile r1 = new readfile(fileName);
       r1.openFile();
       cipher = r1.readFile();
  String input = parseString(cipher);
  //  while(input.equals(""))
 ...
 //   System.out.println();
    ...
    String decodedOutput = decode(output, xyz);
    
    // output the results to user
    this.printTable(table);
    this.printResults(output,decodedOutput, enc);
  }
  ...
  private String decode(String out, String xyz) throws IOException{
    String decoded = "";
  ...
  private void printResults(String enc, String dec, String abc){
	  if(abc.equals("ENC")){
